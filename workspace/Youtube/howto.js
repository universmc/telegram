...
{role: "system",content: "élaboration d'un plan d'action pour le développement d'une interfaces graphiques de l'application Electron en adéquation avec api https://youtube.com" },
{role: "assistant",content: "présentation du diffuseur Youtube la gestion des flux de meta Donnée pour Chiffrer notre diffusion à l'aide de RTMPS " },
    ],
    model: "mixtral-8x7b-32768",
    temperature: 0.6,
    max_tokens: 2048,
