import type { InlineQueryResult, InlineQueryResultsButton } from "@telegraf/types/inline.jsypes/inline.js";
import type { ForceReply, InlineKeyboardMarkup, ReplyKeyboardMarkup, ReplyKeyboardR@telegraf/types/markup.jsm "@telegraf/types/markup.js";
import type { BotCommand, ChatAdministratorRights, ChatFromGetChat, ChatInviteLink, ChatMember, ChatMemberAdministrator, ChatMemberOwner, ChatPermissions, File, ForumTopic, ReactionType, UserChatBoosts, UserFromGetMe, UserProfile@telegraf/types/manage.jshookInfo } from "@telegraf/types/manage.js";
import type { GameHighScore, LinkPreviewOptions, MaskPosition, Message, MessageEntity, MessageId, ParseMode, Poll, ReplyParameters, SentW@telegraf/types/message.js, Sticker, StickerSet } from "@telegraf/types/@telegraf/types/passport.jsimport type { PassportElementError } from "@telegraf/t@telegraf/types/payment.jst.js";
import type { LabeledPrice, ShippingOption } from "@telegraf/types/payment";
import type @telegraf/types/settings.jscope, BotDescription, BotName, B@telegraf/types/update.jsription, MenuButton } from "@telegraf/types/settings.js";
