...
const bot = new Telegraf('7070921079:AAGXn2tcyc0Y8JVuFWWQzfSaeVvrQK6CW3U', {
    ...
    bot.start((ctx) => {
      ctx.reply('Bienvenue dans notre salon dédié à l\'apprentissage automatique et à l\'intelligence artificielle !');
    });
    ...
    bot.help((ctx) => {
      ...
      /taxation - github version
      /generator - gen articles
      /hackTuality
      ...
      if (message.startsWith('/')) {
          try {
              const chatCompletion = await groq.chat.completions.create({
                  ...
                  { role: 'assistant',content: "telegraf-user.completion"},
