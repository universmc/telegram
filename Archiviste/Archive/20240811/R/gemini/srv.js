...
bot.on('message', async (ctx) => {
    ...
    const knowleddge = `${gemini}+${racine}+${cdnJs}+${node}+${make}+${archiviste}+${github}+${dchub_public}+${dchub_prive}+${user_Pibot}+${youtube_Pibot}+${google_Pibot}+${gemini_Pibot}+`
