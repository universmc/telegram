...
// Project plan object
const projectPlan = {
  projectName: "Développement du gantt-chart pour la projet algo-vid (univers-mc.cloud)avec le SystemDream Groq ,",
  phases: [
    { 
      phaseId:"phase0",  
...
const BorderChars = "borderChars";
  ...
  await groq.chat.completions.create({
    ...
    messages: [
        ...
        {role: "assistant",name:"✨_pi", content: "Création d'un guide complet étate par étape pour générer des exemples de script sur la language de programmation groq"},
    ...
    const outputFilePath = "output/_phase1-1_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
