...
const Telegram = `${github}+${widgets}+${universmc}+${universmc_app}+${Pibot}`
...
const context = "/Volumes/devOps"
const integration = `${context}+ ${norm_W3C}+${archiviste}+${github}+` 
...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {role: "system", content: `${integration}+${Telegram}` },
        ...
        const outputFilePath = "music_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".html";
